let apiUrl = {
	...
	GET_BUSSINESS_CATEGORY:
		'/user_service/admin/business_categories/get_business_category',
	...
	GET_PRODUCT_CATEGORIES:
		'/user_service/admin/product_categories/get_categories',
	...
	UPDATE_PRODUCT_CATEGORY_STATUS:
		'/user_service/admin/product_categories/status',
	...
	UPDATE_CUSTOMIZATION_TYPE:
		'/user_service/admin/product_customizations/update_customize_type',
	UPDATE_CUSTOMIZATION_TYPE_STATUS:
		'/user_service/admin/product_customizations/update_status',
	DELETE_CUSTOMIZATION_TYPE:
		'/user_service/admin/product_customizations/delete_type',

	// CUSTOMIZATION SUB TYPES
	GET_CUSTOMIZATION_SUBTYPES:
		'/user_service/admin/product_customizations_subtype/get_subtypes',
	CREATE_CUSTOMIZATION_SUBTYPE:
		'/user_service/admin/product_customizations_subtype/create_subtype',
	GET_CUSTOMIZATION_SUBTYPE:
		'/user_service/admin/product_customizations_subtype/get_subtype',
	UPDATE_CUSTOMIZATION_SUBTYPE:
		'/user_service/admin/product_customizations_subtype/update_subtype',
	UPDATE_CUSTOMIZATION_SUBTYPE_STATUS:
		'/user_service/admin/product_customizations_subtype/update_status',
	DELETE_CUSTOMIZATION_SUBTYPE:
		'/user_service/admin/product_customizations_subtype/delete_subtype',
	...
	GET_DEALOFDAY_PRODUCTS:
		'/user_service/admin/dealofday/get_dealofday_products',
	...
	GET_RECONCILATION_REPORT:
		'/user_service/admin/report/get_reconcilation_report',
};
