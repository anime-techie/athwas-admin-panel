...
class ListPageHeading extends Component {
  ...
  render() {
    ...
    var statusOptions1 = statusOptions.find(
      (item) => item.column == filterStatus
    );
    var daysOptions1 = daysOptions.find((item) => item.value == daysStatus);
    var amountOptions1 = amountOptions.find(
      (item) => item.value == amountStatus
    );
    var activeOptions1 = activeOptions.find(
      (item) => item.column == activeStatus
    );
                          ...
                          {daysOptions.map((status, index) => {
                            return (
                              <DropdownItem
                                ...
                                onClick={() => {
                                  this.setState({
                                    selectedDaysOption: daysOptions[index],
                                  });
                          ...
                          {amountOptions.map((status, index) => {
                            return (
                              <DropdownItem
                                ...
                                onClick={() => {
                                  this.setState({
                                    selectedAmountOption: amountOptions[index],
                                  });
                          ...
                          {activeOptions.map((status, index) => {
                            return (
                              <DropdownItem
                                ...
                                onClick={() => {
                                  this.setState({
                                    selectedActiveStatus: activeOptions[index],
                                  });
                          ...
                          {statusOptions.map((status, index) => {
                            return (
                              <DropdownItem
                                ...
                                onClick={() => {
                                  this.setState({
                                    selectedStatusOption: statusOptions[index],
                                  });
