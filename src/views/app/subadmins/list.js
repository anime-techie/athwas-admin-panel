...
class SubadminList extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      addNewItemRoute: "/app/add-subadmin",
      ...
      searchPlaceholder: "Search by User Name, Email, Mobile Number",
      searchKeyword: "",
      filterFromDate: "",
      filterToDate: "",
      filterStatus: "",
  ...
  onDeleteItem = async (itemId, index) => {
    swalWithBootstrapButtonsDelete
      ...
      .then(async (result) => {
        if (result.value) {
          let path = ApiRoutes.DELETE_SUBADMIN + "/" + itemId;
                        ...
                        return (
                          <tr key={index}>
                            ...
                            <td>
                              ...
                              />{" "}
                              <NavLink to={`edit-subadmin/${item._id}`}>
                                <Button
                                  outline
                                  color="info"
                                  size="xs"
