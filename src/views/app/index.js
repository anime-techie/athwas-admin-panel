...
const ActiveInactiveList = React.lazy(() =>
  import("./active-inactive-users/list")
);
...
// BUSINESS CATEGORIES
const BusinessCategoryAdd = React.lazy(() =>
  import("./business-categories/add")
);
const BusinessCategoryList = React.lazy(() =>
  import("./business-categories/list")
);
const BusinessCategoryEdit = React.lazy(() =>
  import("./business-categories/edit")
);

// PRODUCT CATEGORIES
const ProductCategoryAdd = React.lazy(() => import("./product-categories/add"));
const ProductCategoryList = React.lazy(() =>
  import("./product-categories/list")
);
const ProductCategoryEdit = React.lazy(() =>
  import("./product-categories/edit")
);

// PRODUCT SUBCATEGORIES
const ProductSubCategoryAdd = React.lazy(() =>
  import("./product-subcategories/add")
);
const ProductSubCategoryList = React.lazy(() =>
  import("./product-subcategories/list")
);
const ProductSubCategoryEdit = React.lazy(() =>
  import("./product-subcategories/edit")
);
...
const CustomizeSubTypeAdd = React.lazy(() =>
  import("./customize-subtypes/add")
);
const CustomizeSubTypeList = React.lazy(() =>
  import("./customize-subtypes/list")
);
const CustomizeSubTypeEdit = React.lazy(() =>
  import("./customize-subtypes/edit")
);
...
const TermCondition = React.lazy(() => import("./contents/terms-condition"));
const ContactUs = React.lazy(() => import("./contents/contact-us"));
const TermOfUse = React.lazy(() => import("./contents/term-of-use"));
...
const CollectionReport = React.lazy(() =>
  import("./reports/collection-report")
);
const ReconcilationReport = React.lazy(() =>
  import("./reports/reconcilation-report")
);
...
const DeliverySettings = React.lazy(() =>
  import("./settings/delivery-settings")
);
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      userPermissions: userData.user_permissions
        ? JSON.parse(userData.user_permissions)
        : {},
    ...
    routesItems = routesItems.map((item) => {
      ...
      if (
        ...
        (!this.state.userPermissions[item.module_slug] ||
          (this.state.userPermissions[item.module_slug] &&
            this.state.userPermissions[item.module_slug].indexOf(
