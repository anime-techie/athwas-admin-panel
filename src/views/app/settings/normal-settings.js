...
class Settings extends Component {
  ...
  handleSubmit = async (inputValues) => {
    ...
    formData.append(
      "normal_start_delivery_time",
      inputValues.normal_start_delivery_time
    );
    formData.append(
      "normal_end_delivery_time",
      inputValues.normal_end_delivery_time
    );
    // formData.append("premium_order_amount", inputValues.premium_order_amount);
    // formData.append(
    //   "premium_start_delivery_time",
    //   inputValues.premium_start_delivery_time
    // );
    // formData.append(
    //   "premium_end_delivery_time",
    //   inputValues.premium_end_delivery_time
    // );
              ...
              <CardBody>
                <Formik
                  ...
                  initialValues={{
                    ...
                    normal_start_delivery_time:
                      this.state.normal_start_delivery_time,
                    normal_end_delivery_time:
                      this.state.normal_end_delivery_time,
                    // premium_order_amount: this.state.premium_order_amount,
                    // premium_start_delivery_time:
                    //   this.state.premium_start_delivery_time,
                    // premium_end_delivery_time:
                    //   this.state.premium_end_delivery_time,
                      ...
                      <Row>
                        ...
                        <Colxx xxs="12" sm="6">
                          <FormGroup className="form-group has-float-label">
                            ...
                            touched.normal_start_delivery_time ? (
                              <div className="invalid-feedback d-block">
                                {errors.normal_start_delivery_time}
                              </div>
                            ) : null}
                        ...
                        <Colxx xxs="12" sm="6">
                          <FormGroup className="form-group has-float-label">
                            ...
                            touched.normal_end_delivery_time ? (
                              <div className="invalid-feedback d-block">
                                {errors.normal_end_delivery_time}
                              </div>
                            ) : null}
                      ...
                      {/* <Row>
                        ...
                        <Colxx xxs="12" sm="4">
                          <FormGroup className="form-group has-float-label">
                            ...
                            />
                            {errors.premium_start_delivery_time &&
                            touched.premium_start_delivery_time ? (
                              <div className="invalid-feedback d-block">
                        ...
                        <Colxx xxs="12" sm="4">
                          <FormGroup className="form-group has-float-label">
                            ...
                            touched.premium_end_delivery_time ? (
                              <div className="invalid-feedback d-block">
                                {errors.premium_end_delivery_time}
                              </div>
                            ) : null}
                        ...
                        <Colxx xxs="12" sm="4">
                          <FormGroup className="form-group has-float-label">
                            ...
                            <Field
                              ...
                              type="text"
                            />
                            {errors.total_sale && touched.total_sale ? (
                              <div className="invalid-feedback d-block">
                                {errors.total_sale}
                              </div>
                            ) : null}
