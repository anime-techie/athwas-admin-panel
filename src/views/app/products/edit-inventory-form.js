...
const InventoryFormSchema = Yup.object().shape({
  ...
  cgst_rate: Yup.string().when("tax_type", {
  ...
  sgst_rate: Yup.string().when("tax_type", {
    is: (tax_type) => tax_type == "1",
    then: Yup.string()
  ...
  discount_value: Yup.string().when("is_discount", {
    is: (is_discount) => is_discount == "1",
...
class InventoryForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      currentPage: this.props.history.location.state
        ? this.props.history.location.state.pageIndex
        : 1,
  ...
  getWarehouseList = async () => {
    ...
    let path = ApiRoutes.GET_WAREHOUSES + "?status=1";
  ...
  onRemoveWarehouseCustomizeForm = async (index) => {
    ...
    console.log("customizeWarehouseFormsClone", customizeWarehouseFormsClone);
  ...
  handleFinalSubmit = async (e) => {
    ...
    setTimeout(async () => {
      ...
      formData.append(
        "tax_type",
        this.state.tax_type ? this.state.tax_type : 0
      );
      formData.append("hsn_code", this.state.hsn_code);
      formData.append(
        "inventory_product_code",
        this.state.inventory_product_code
      );
  ...
  onChangeProductValue = (value, setFieldValue) => {
    ...
    var {
      ...
      sgst_rate,
      igst_rate,
      old_cgst_rate = cgst_rate,
      old_sgst_rate = sgst_rate,
      old_igst_rate = igst_rate,
    } = this.state;
    ...
    if (discount_type == 1 && discount_type != "") {
      ...
      this.setState({
        discounted_product_price: discountedPrice.toFixed(2),
      });
    } else {
                        ...
                        <Row>
                          ...
                          <Colxx xxs="12" sm="3">
                            <FormGroup className="form-group has-float-label">
                              ...
                              touched.inventory_product_code ? (
                                <div className="invalid-feedback d-block">
                                  {errors.inventory_product_code}
                                </div>
                              ) : null}
                            ...
                            <FormGroup className="error-l-175">
                              ...
                              <FormikCustomRadioGroup
                                ...
                                onChange={(event, value) => {
                                  setFieldValue("is_discount", value);
                            ...
                            <Row>
                              ...
                              <Colxx xxs="12" sm="3">
                                <FormGroup className="form-group has-float-label">
                                  ...
                                  touched.discounted_product_price ? (
                                    <div className="invalid-feedback d-block">
                                      {errors.discounted_product_price}
                                    </div>
                                  ) : null}
                          ...
                          <Colxx xxs="12" sm="3">
                            <FormGroup className="form-group has-float-label">
                              ...
                              <Field
                                ...
                                type="text"
                                onChange={(event, value) => {
                                  setFieldValue("tax_rate", event.target.value);
                                  this.setState(
                            ...
                            <FormGroup className="form-group has-float-label">
                              ...
                              <Field
                                ...
                                onChange={(event, value) => {
                                  ...
                                  this.setState(
                                    { taxable_amount: event.target.value },
                                    () => {
                                      this.onChangeProductValue(
                              ...
                              <FormGroup className="form-group has-float-label">
                                ...
                                <Field
                                  ...
                                  onChange={(event, value) => {
                                    ...
                                    this.setState(
                                      { igst_rate: event.target.value },
                                      () => {
                                        this.onChangeProductValue(
                                          this.state.igst_rate,
                                          setFieldValue
                                        );
                                      }
                                    );
                              ...
                              <FormGroup className="form-group has-float-label">
                                ...
                                <Field
                                  ...
                                  onChange={(event, value) => {
                                    ...
                                    this.setState(
                                      { igst_amount: event.target.value },
                                      () => {
                                        this.onChangeProductValue(
                                ...
                                <FormGroup className="form-group has-float-label">
                                  ...
                                  <Field
                                    ...
                                    onChange={(event, value) => {
                                      ...
                                      this.setState(
                                        { cgst_rate: event.target.value },
                                        () => {
                                          this.onChangeProductValue(
                                            this.state.cgst_rate,
                                            setFieldValue
                                          );
                                        }
                                      );
                                ...
                                <FormGroup className="form-group has-float-label">
                                  ...
                                  <Field
                                    ...
                                    onChange={(event, value) => {
                                      ...
                                      this.setState(
                                        { cgst_amount: event.target.value },
                                        () => {
                                          this.onChangeProductValue(
                                ...
                                <FormGroup className="form-group has-float-label">
                                  ...
                                  <Field
                                    ...
                                    onChange={(event, value) => {
                                      ...
                                      this.setState(
                                        { sgst_rate: event.target.value },
                                        () => {
                                          this.onChangeProductValue(
                                            this.state.sgst_rate,
                                            setFieldValue
                                          );
                                        }
                                      );
                                ...
                                <FormGroup className="form-group has-float-label">
                                  ...
                                  <Field
                                    ...
                                    onChange={(event, value) => {
                                      ...
                                      this.setState(
                                        { sgst_amount: event.target.value },
                                        () => {
                                          this.onChangeProductValue(
                          ...
                          <Colxx xxs="12" sm="3">
                            <FormGroup className="form-group has-float-label">
                              ...
                              <Field
                                ...
                                type="text"
                              />
                              {errors.sku_name && touched.sku_name ? (
                                <div className="invalid-feedback d-block">
                                  {errors.sku_name}
                                </div>
                              ) : null}
                  ...
                  {this.state.customizeForms.map((value, index) => {
                    return (
                      <Formik
                        ...
                        initialValues={{
                          custom_type:
                            this.state.customizeForms[index].custom_type,
                          custom_type_value:
                            this.state.customizeForms[index].custom_type_value,
                        }}
                        ...
                        initialValues={{
                          warehouse_id:
                            this.state.customizeWarehouseForms[index]
                              .warehouse_id,
                          quantity:
                            this.state.customizeWarehouseForms[index].quantity,
                        }}
