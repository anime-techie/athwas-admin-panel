...
const InventoryFormSchema = Yup.object().shape({
  ...
  igst_rate: Yup.string().when("tax_type", {
                          ...
                          <Colxx xxs="12" sm="3">
                            <FormGroup className="error-l-175">
                              ...
                              <FormikCustomRadioGroup
                                ...
                                //   );
                                //   this.setState({
                                //     is_discount: event.target.value,
                                //   });
                                //   this.setState(
                                //     {
                                //       discount_type:
                                ...
                                //         event.target.value == "0"
                                //           ? 0
                                //           : values.discounted_product_price,
                                //     },
                                //     () => {
                                //       this.onChangeProductValue(
                                //         this.state.discounted_product_price,
                            ...
                            <Colxx xxs="12" sm="3">
                              <FormGroup className="form-group has-float-label">
                                ...
                                <Field
                                  ...
                                  type="text"
                                  readOnly
                                  value={this.state.discounted_product_price}
                                />
