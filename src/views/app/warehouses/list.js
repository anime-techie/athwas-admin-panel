...
class WarehouseList extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      addNewItemRoute: "/app/add-warehouse",
    ...
    swalWithBootstrapButtonsStatus
      ...
      .then(async (result) => {
        if (result.value) {
          ...
          let path = ApiRoutes.UPDATE_WAREHOUSE_STATUS + "/" + itemId;
  ...
  onDeleteItem = async (itemId, index) => {
    swalWithBootstrapButtonsDelete
      ...
      .then(async (result) => {
        if (result.value) {
          let path = ApiRoutes.DELETE_WAREHOUSE + "/" + itemId;
                        ...
                        return (
                          <tr key={index}>
                            ...
                            <td>
                              <Link
                                to={{
                                  pathname: `edit-warehouse/${item._id}`,
                                  state: {
