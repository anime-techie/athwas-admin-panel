    ...
    swalWithBootstrapButtonsStatus
      ...
      .then(async (result) => {
        if (result.value) {
          ...
          if (category_name == 1) {
            path =
              ApiRoutes.UPDATE_GROCERY_ORDER_STATUS +
              "/" +
              orderId +
              "/" +
              newStatus +
            ...
            path =
              ApiRoutes.UPDATE_NORMAL_ORDER_STATUS +
              "/" +
              orderId +
              "/" +
              newStatus +
                            ...
                            <CardBody>
                              ...
                              <Row>
                                <Colxx xxs="6" sm="6">
                                  <p>
                                    Order Date :{" "}
                                    {moment(
                                      this.state.orderData.order_date
                                    ).format("LLLL")}
                                  </p>
                                </Colxx>
                                <Colxx xxs="6" sm="6">
                                  {this.state.orderData.order_status != 0
                                    ? newstatus1[
                                        this.state.orderData.order_status
                                      ]
                                    : "Pending"}
                                </Colxx>
                              </Row>
                                ...
                                <Colxx xxs="6" sm="6">
                                  <p>
                                    ...
                                    {this.state.warehouseData.length > 0 &&
                                      this.state.warehouseData[0]._id}
                                  </p>
                                </Colxx>
                                <Colxx xxs="6" sm="6">
                                  <p>
                                    Warehouse Name:{" "}
                                    {this.state.warehouseData.length > 0 &&
                                      this.state.warehouseData[0].name}
                                  </p>
                                </Colxx>
                              </Row>
                              <hr />
                              ...
                              <Row>
                                <Colxx xxs="6" sm="6">
                                  <p>
                                    Customer Id:{" "}
                                    {this.state.userData.register_id}
                                  </p>
                                </Colxx>
                                <Colxx xxs="6" sm="6">
                                  <p>
                              ...
                              <p>
                                Delivery Address:{" "}
                                {this.state.orderData &&
                                this.state.orderData.delivery_address &&
                                this.state.orderData.delivery_address
                                  .full_address
                                  ? this.state.orderData.delivery_address
                                      .full_address
                              ...
                              <p>
                                ...
                                {this.state.orderData &&
                                this.state.orderData.delivery_address &&
                                this.state.orderData.delivery_address.zip_code
                                  ? this.state.orderData.delivery_address
                                      .zip_code
                                  : ""}{" "}
                              </p>
                                ...
                                <Colxx xxs="6" sm="6">
                                  <p>
                                    ...
                                    {this.state.driverData.length > 0 &&
                                      this.state.driverData[0].register_id}
                                  </p>
                                </Colxx>
                                <Colxx xxs="6" sm="6">
                                  <p>
                                    Driver Name:{" "}
                                    {this.state.driverData.length > 0 &&
                                      this.state.driverData[0].username}
                                  </p>
                                </Colxx>
                              </Row>
                              ...
                              <Row>
                                <Colxx xxs="6" sm="6">
                                  <p>
                                    Order Picked up:{" "}
                                    {this.state.packedData &&
                                    this.state.packedData.status == 0
                                      ? "No"
                                      : "Yes"}
                                  </p>
                                </Colxx>
                                <Colxx xxs="6" sm="6">
                                  <p>
                                    Picked Up Date:{" "}
                                    {this.state.packedData &&
                                      this.state.packedData.time &&
                                      moment(this.state.packedData.time).format(
                                        "LLLL"
                                      )}
                                  </p>
                                </Colxx>
                              ...
                              <Row>
                                <Colxx xxs="6" sm="6">
                                  <p>
                                    Order In Transit:{" "}
                                    {this.state.transitData &&
                                    this.state.transitData.status == 0
                                      ? "No"
                                      : "Yes"}
                                  </p>
                                </Colxx>
                              ...
                              <Row>
                                <Colxx xxs="6" sm="6">
                                  <p>
                                    Delivered:{" "}
                                    {this.state.deliveredData &&
                                    this.state.deliveredData.status == 0
                                      ? "No"
                                      : "Yes"}
                                  </p>
                                </Colxx>
                              ...
                              <Row>
                                ...
                                <Colxx xxs="6" sm="6">
                                  <p>
                                    ...
                                    {this.state.orderData.expected_end_date &&
                                      moment(
                                        this.state.orderData.expected_end_date
                                      ).format("LLLL")}
                                  </p>
                                      ...
                                      <Colxx xxs="4" sm="4">
                                        {
                                          item &&
                                          item.all_return == 1 &&
                                          item.products[0].order_status == 1 ? (
                                            <>
                                              <Button
                                                outline
                                                color="success"
                                ...
                                <tbody>
                                  ...
                                  {/* <tr>
                                    ...
                                    <td className="text-right">
                                      Rs{" "}
                                      {this.state.orderData &&
                                        this.state.orderData.vat_amount}
                                    </td>
                                  </tr> */}
                                  <tr>
                                    <td className="font-weight-bold">
                                    ...
                                    <td className="text-right">
                                      Rs{" "}
                                      {this.state.orderData &&
                                        this.state.orderData.discount.toFixed(
                                          2
                                        )}
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td className="text-right">
                                      Rs{" "}
                                      {this.state.orderData &&
                                        this.state.orderData.net_amount}
                                    </td>
                                  </tr>
                                  {/* <tr>
                                    <td className="font-weight-bold">
