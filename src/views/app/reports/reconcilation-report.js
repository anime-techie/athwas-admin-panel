    ...
    if (res) {
      if (res.status == 200) {
        ...
        resultUsersJson.docs.map((product, index) => {
          const csvData1 = {};
          csvData1["SKU Code"] = product.sku_code;
          csvData1["SKU Name"] = product.sku_name;
          csvData1["Batch"] = product.batch;
          csvData1["MRP"] = product.price;
          csvData1["Product Code"] = product.inventory_product_code
          ...
          csvData1["Product Sub Category"] = product.subcategory.name;
          csvData1["Physical quantity"] = inputValues.physical_quantity;
          csvData1["Available quantity"] = product.available_quantity;
          csvData1["variance"] =
            inputValues.physical_quantity - product.available_quantity;
          csvData1["ira"] =
            (product.available_quantity * inputValues.physical_quantity) / 100;
          csvData1["Order Date."] = moment(product.createdAt).format("lll");
          csvData1["Invoice Date."] = moment(product.createdAt).format("lll");
      ...
      <Fragment>
        <div>
          ...
          >
            <CSVLink
              ...
              filename={"reconcilation-analysis.csv"}
            >
        ...
        <div className="disable-text-selection">
          <Row>
            <Colxx xxs="12">
              <Breadcrumb
                heading="heading.reconcilation-report"
