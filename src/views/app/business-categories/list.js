...
class BusinessCategoriesList extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      addNewItemRoute: "/app/add-business-category",
  ...
  async componentDidMount() {
    (await this.props.history.location.state)
      ? this.setState({
    ...
    swalWithBootstrapButtonsStatus
      ...
      .then(async (result) => {
        if (result.value) {
          ...
          let path = ApiRoutes.UPDATE_BUSSINESS_CATEGORY_STATUS + "/" + itemId;
  ...
  onDeleteItem = async (itemId, index) => {
    swalWithBootstrapButtonsDelete
      ...
      .then(async (result) => {
        if (result.value) {
          let path = ApiRoutes.DELETE_BUSSINESS_CATEGORY + "/" + itemId;
    ...
    return this.state.isLoading ? (
      ...
      <Fragment>
        <div className="disable-text-selection">
          <ListPageHeading
            heading="menu.business-categories"
            match={match}
                          ...
                          return (
                            <tr key={index}>
                              ...
                              <td>
                                <img
                                  alt={item.name}
                                  src={item.category_image_thumb_url}
