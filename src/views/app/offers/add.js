...
class AddOffer extends Component {
  ...
  handleSubmit = async (inputValues, formOptions) => {
    ...
    formData.append(
      ...
      inputValues.business_category != "" ? inputValues.business_category : ""
    );
    formData.append(
      "category_id",
      inputValues.product_category != "" ? inputValues.product_category : ""
    );
    formData.append(
      "sub_category_id",
    ...
    formData.append(
      "product_id",
      inputValues.product_inv_id != "" ? JSON.stringify(productData) : []
    );
    ...
    formData.append(
      "offer_amount_type",
      inputValues.offer_amount_type != "" ? inputValues.offer_amount_type : ""
    );
    formData.append(
      "offer_price",
    ...
    formData.append(
      "offer_amount",
      inputValues.offer_amount != "" ? inputValues.offer_amount : ""
    );
